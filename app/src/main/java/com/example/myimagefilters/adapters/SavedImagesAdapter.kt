...
import com.example.myimagefilters.databinding.ItemContainerSavedImageBinding
import com.example.myimagefilters.listeners.SavedImageListener
import java.io.File

class SavedImagesAdapter(private val savedImages: List<Pair<File, Bitmap>>, private val savedImageListener: SavedImageListener): RecyclerView.Adapter<SavedImagesAdapter.SavedImageViewHolder>() {
