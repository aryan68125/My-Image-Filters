...
class EditImageRepositoryImpl(private val context: Context): EditImageRepository {
    ...
    override suspend fun saveFilteredImage(filteredBitmap: Bitmap): Uri? {
        return try{
            //This code will save the image in the internal file directory of the application
    ...
    //This function will handle the filtered image into the system's primary memory as a separate image file
