...
class SavedImagesRepositoryImpl(private val context: Context): SavedImagesRepository {
    ...
    //this function will load the images into the memory after getting them from the storage
    ...
    //this function will get the image files from the application storage
